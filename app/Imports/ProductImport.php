    ...
    public function model(array $row)
    {
        ...
        try {
            ...
            $product = new Product([
                ...
                'unit' => ($row['unit'] ?? null) ?: '1',
                'quantity' => $row['quantity'] ?? $quantity ?? 0,
                'weight' => $row['weight'] ?? 0,
                'price' => $price ?? $row['price'] ?? 0,
                'sale_price' => $sale_price ?? $row['sale_price'] ?? 0,
                'discount' => $discount ?? $row['discount'] ?? 0,
                'sku' => $row['sku'] ?? null,
                'stock_status' => $stock_status ?? $row['stock_status'] ?? 'in_stock',
                'meta_title' => $row['meta_title'] ?? $row['name'] ?? null,
                'meta_description' => $row['meta_description'] ?? $row['description'] ?? null,
                ...
                'shipping_days' => $row['shipping_days'] ?? 0,
                'show_stock_quantity' => $row['show_stock_quantity'] ?? 1,
                'estimated_delivery_text' => $row['estimated_delivery_text'] ?? null,
                'return_policy_text' => $row['return_policy_text'] ?? null,
                'safe_checkout' => $row['safe_checkout'] ?? 1,
                'secure_checkout' => $row['secure_checkout'] ?? 1,
                'social_share' => $row['social_share'] ?? 1,
