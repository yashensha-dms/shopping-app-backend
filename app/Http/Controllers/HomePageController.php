...
class HomePageController extends Controller
{
    ...
    /**
     * Get app settings for mobile app home page configuration
     *
     * @return \Illuminate\Http\Response
     */
    ...
    {
        $slug = Helpers::getActiveTheme();
        $homePage = $this->repository->where('slug', $slug)->first();
        ...
        // Renaming 'content' to 'values' to match the expected API structure
        return response()->json([
            'id' => $homePage->id,
            'values' => $homePage->content,
