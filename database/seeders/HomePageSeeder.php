...
class HomePageSeeder extends Seeder
{
    ...
    {
        $contents = [
            // Grocery theme - Mobile App compatible structure
            'grocery' => [
                'content' => [
                    'blogs' => [
                        ...
                        'status' => true,
                        'blog_ids' => [],
                        'sub_title' => 'Uncover Featured Offers of mStore'
                    ],
                    'brands' => [
                        'title' => 'Top Brands',
                        'status' => true,
                    ...
                    'seller' => [
                        ...
                        'status' => true,
                        'store_ids' => [],
                        'sub_title' => 'A virtual assistant collects the sellers from your list.'
                    ],
                    'coupons' => [
                        'title' => 'Coupons',
                        'status' => true,
                        'sub_title' => 'coupon youve earned along the way',
                        'coupon_ids' => []
                    ],
                    'home_banner' => [
                        'status' => true,
                        'banners' => [
                            [
                                'status' => true,
                                'image_url' => $this->baseURL.'/frontend/images/themes/grocery/banner1.png',
                                'redirect_link' => [
                                    'link' => '',
                            ...
                            [
                                'status' => true,
                                'image_url' => $this->baseURL.'/frontend/images/themes/grocery/banner2.png',
                                'redirect_link' => [
                                    'link' => '',
                                    'link_type' => 'collection'
                                ]
                            ...
                            [
                                'status' => true,
                                'image_url' => $this->baseURL.'/frontend/images/themes/grocery/banner3.png',
                                'redirect_link' => [
                                    'link' => '',
                                    'link_type' => 'collection'
                                ]
                            ...
                            [
                                'status' => true,
                                'image_url' => $this->baseURL.'/frontend/images/themes/grocery/banner4.png',
                                'redirect_link' => [
                                    'link' => '',
                                    'link_type' => 'collection'
                                ]
                    ...
                    'offer_products' => [
                        ...
                        'status' => true,
                        'sub_title' => "Don't miss this opportunity at a special discount just for this week.",
                        'product_ids' => []
                    ],
                    'categories_list' => [
                    ...
                    'section_1_products' => [
                        ...
                        'status' => true,
                        'sub_title' => 'Morning Delights: Breakfast and Dairy Choices to Start Your Day',
                        'product_ids' => []
                    ],
                    'section_2_products' => [
                        'title' => 'Fresh Veggies And Fruits',
                        'status' => true,
                        'sub_title' => 'Farm-Fresh Goodness: A Variety of Fruits and Vegetables Awaits.',
                        'product_ids' => []
                    ],
                    'section_3_products' => [
                        'title' => 'Our Best Selling',
                        'status' => true,
                        'sub_title' => 'A virtual assistant collects the products from your list.',
                        'product_ids' => []
                    ]
                ]
            ],
