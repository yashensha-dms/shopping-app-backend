  ...
  public function run()
  {
    $options = [
      ...
      'header' => [
        ...
        'top_bar_content' => [
          [
              "content" => "<strong class=\"me-1\">Welcome to Mstore!</strong>Wrap new offers/gift every single day on Weekends.<strong class=\"ms-1\">New Coupon Code: FAST50</strong>"
          ],
          [
      ...
      'footer' => [
        ...
        'copyright_content' => '©2023 Mstore All rights reserved',
        ...
        'about_email' => 'support@Mstore.com',
        'footer_categories' => [],
        'useful_link' => [],
        'help_center' => [],
        "support_number" => "+1-555-186-5359",
        'support_email' => 'support@Mstore.com',
      ...
      'seller' => [
        'about' => [
          'status' => true,
          'title' => 'BECOME A SELLER ON Mstore..',
        ...
        'steps' =>  [
          'status' => true,
          "title" => "Doing Business On Mstore Is Really Easy",
          'step_1' => [
        ...
        'start_selling' => [
          'status' => true,
          'title' => "Start Selling",
          'description' => "Mstore marketplace is India's leading platform for selling online. Be it a manufacturer, vendor or supplier, simply sell your products online on Mstore and become a top ecommerce player with minimum investment. Through a team of experts offering exclusive seller workshops, training, seller support and convenient seller portal, Mstore focuses on educating and empowering sellers across India. Selling on Mstore.com is easy and absolutely free. All you need is to register, list your catalogue and start selling your products."
        ],
      ...
      'seo' => [
        'meta_tags' => 'Mstore Marketplace: Where Vendors Shine Together',
        "meta_title" => "Online Marketplace, Vendor Collaboration, E-commerce Platform",
        "meta_description" => "Discover Mstore Marketplace – a vibrant online platform where vendors unite to showcase their products, creating a diverse shopping experience. Explore a wide range of offerings and connect with sellers on a single platform.",
        "og_title" => "Mstore Marketplace: Uniting Vendors for Shopping Excellence",
        "og_description" => "Experience a unique shopping journey at Mstore Marketplace, where vendors collaborate to provide a vast array of products. Explore, shop, and connect in one convenient destination.",
        'og_image_id' => null
      ],
    ];
